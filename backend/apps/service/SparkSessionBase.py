...
class SparkSessionBase:
    ...
    def _create_spark_session(self):
        ...
        if not os.environ.get('HADOOP_CONF_DIR'):
            os.environ['HADOOP_CONF_DIR'] = 'D:\\pythonProject\\comment-analysis-08\\conf\\hadoop-conf'

        if not os.environ.get('YARN_CONF_DIR'):
            os.environ['YARN_CONF_DIR'] = 'D:\\pythonProject\\comment-analysis-08\\conf\\yarn-conf'
